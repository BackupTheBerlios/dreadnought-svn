...
FCKConfig.CustomConfigurationsPath = '/FCKeditorTest/config.js' ;
...
FCKConfig.StylesXmlPath		= FCKConfig.EditorPath + 'Editor/styles.xml' ;
FCKConfig.TemplatesXmlPath	= FCKConfig.EditorPath + 'Editor/templates.xml' ;
